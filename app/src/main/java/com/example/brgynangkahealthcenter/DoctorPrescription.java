...
public class DoctorPrescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(DoctorPrescription.this, DoctorHome.class);
            }
        });
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(DoctorPrescription.this, DoctorDashboard.class);
            }
        });
        ...
        consultation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(DoctorPrescription.this, DoctorConsultation.class);
            }
        });
        ...
        users.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(DoctorPrescription.this, DoctorUsers.class);
            }
        });
        ...
        inventory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(DoctorPrescription.this, DoctorInventory.class);
            }
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(DoctorPrescription.this, "Logout", Toast.LENGTH_SHORT).show();
            }
        });
