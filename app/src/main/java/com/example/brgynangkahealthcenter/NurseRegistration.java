...
public class NurseRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = database.getReference("Nurse");
        ...
        signupBirthday.setOnClickListener((View view) -> {
            ...
            //Date Picker Dialog
            picker = new DatePickerDialog(NurseRegistration.this, (datePicker, year1, month1, dayofMonth) -> signupBirthday.setText(dayofMonth + "/" + (month1 + 1)+"/"+ year1), year, month, day);
            picker.show();
        });
        ...
        signupButton.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(firstname) || TextUtils.isEmpty(lastname) || TextUtils.isEmpty(birthday)
                ...
                Toast.makeText(NurseRegistration.this, "All fields are required", Toast.LENGTH_SHORT).show();
                return;
            }

            if (!mobileMatcher.find()){
                Toast.makeText(NurseRegistration.this, "Mobile No. is not valid", Toast.LENGTH_SHORT).show();
                return;
            }

            int selectedGenderId = radioGroupRegisterGender.getCheckedRadioButtonId();
            if (selectedGenderId == -1) {
                Toast.makeText(NurseRegistration.this, "Please select your gender", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (!password.equals(confirm_password)) {
                Toast.makeText(NurseRegistration.this, "Passwords do not match", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                if (intAge < 0) {
                    Toast.makeText(NurseRegistration.this, "Age should be a positive integer", Toast.LENGTH_SHORT).show();
                    return;
                }
